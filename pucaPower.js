...
var pucaPower = {
        ...
        formUrl: 'https://pad333.github.io/Puca-Power/controls.html',
        ...
        checkForAlerts: function () {
            ...
            for ( i in this.memberData ) {
                ...
                if ( this.alert.onBundle && tradeValue >= this.alert.bundleThreshold && cardQty >= this.alert.bundleMinQty  ) {
        ...
        filterTrades: function () {
            ...
            var i;
            var filterQty = 0;
            var memberID, memberName, memberPts, cardQty, hasAlert;
            ...
            for (i = 0; i < this.tableData.length; i++) {
                ...
                memberPts  = this.memberData[memberID].memberPts;
                cardQty = this.memberData[memberID].cardQty;
...
setupListeners: function () {
    ...
    $('input#filterMembersByQty').click(this.updatePageState.bind(this));
